...
const XML10_NAME_CHAR = `${XML10_LETTER +
  XML10_DIGIT}\\._:${XML10_COMBINING_CHAR}${XML10_EXTENDER}-`;
...
const XML11_NAME_CHAR =
  XML11_NAME_START_CHAR + "\\.0-9\u00b7\u0300-\u036f\u203f-\u2040-";
...
const XML_NC_NAME_CHAR = `${XML10_LETTER +
  XML10_DIGIT}\\._${XML10_COMBINING_CHAR}${XML10_EXTENDER}-`;
